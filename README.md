...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/rsycz/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/rsycz/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/rsycz/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/rsycz/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/rsycz/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/rsycz/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |         18m24.714s        |        1m42.279s          | 
| `pg_normalized_batch`  |         3m29.850s         |        0m12.495s          | 
| `pg_denormalized`      |         0m14.765s         |        0m2.850s           | 
